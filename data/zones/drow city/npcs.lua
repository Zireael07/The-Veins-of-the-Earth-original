...
--load("/data/general/npcs/animals.lua", function(e) e.faction = "neutral" end, rarity(8))
load("/data/general/npcs/vermin.lua", function(e) e.faction = "neutral" end, rarity(6))
load("/data/general/npcs/elementals.lua", function(e) e.faction = "neutral" end, rarity(10))
load("/data/general/npcs/outsider_evil.lua", function(e) e.faction = "neutral" end, rarity(15))
