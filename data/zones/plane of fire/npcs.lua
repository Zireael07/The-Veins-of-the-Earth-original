...
load("/data/general/npcs/elementals.lua", function(e) if e.rarity and e.name and e.name:find("water") then e.rarity=nil end end, rarity(5))
...
load("/data/general/npcs/outsider_fire.lua", rarity(0))
