...
newEntity{ base = "BASE_NPC_MAGBEAST",
	...
	uncommon_desc = [[Two notable offshoots of the hydra exist. Pyrohydras are reddish brown and can breathe juts of flame from each of their heads every few moments. Cyrohydras are purplish and breathe blasts of cold. Pyrohydras have the fire subtype; cyrohydras have the cold subtype. Since a pyrohydra is immune to fire, only acid or cold can seal its severed stumps. Acid and fire remain effective against cryohydras.]],
	common_desc = [[Depending on its age and size, a hydra may have anywhere from five to twelve heads, each of which can snap separately at foes and prey. Hydras heal from wounds with remarkable speed, and if a head is severed, two new heads sprout from the stump within a few moments. The most effective means of killing a hydra is to sunder its heads, then sear each stump shut with acid or flame before new heads can grow. A hydra cannot survive if all of its heads are severed and its stumps sealed.]],
	base_desc = "This many-headed reptilian monster is a hydra. These deadly predators stalk desolate swamps.",
