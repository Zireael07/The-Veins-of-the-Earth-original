...
newEntity{ base = "BASE_NPC_MAGBEAST",
	...
	uncommon_desc = [[The warning clicks released by a shocker lizard are actually low-powered electrical discharges, and can make nearby creatures' skin crawl. A shocker lizard can sense any nearby electrical discharge. A single shocker lizard cannot generate a lethal electrical discharge, but a group of them can combine their output to create crackling bolts of lightning.]],
	common_desc = [[A shocker lizard’s body can generate a powerful electrical charge. When threatened by larger creatures, it warns off predators with a series of rapid, unsettling clicks. If the foe does not retreat, the lizard raises its horns, a sign that it is ready to attack. A shocker lizard defends itself by releasing arcs of electricity into nearby creatures, leaving them stunned. A shocker lizard is immune to electricity.]],
	base_desc = "The blue-gray hide and broad black stripes on this sleek, dog-sized reptile mark it as a shocker lizard.",
...
newEntity{ base = "BASE_NPC_MAGBEAST",
	...
	body_parts = { torso=1, arms=1, legs=1, head=1, wing=1, tail=1 },
...
newEntity{ base = "BASE_NPC_MAGBEAST",
	...
	common_desc = [[A girallon that gets a hold of a creature with two arms quickly attempts to rip the creature apart.]],
	base_desc = "This hairy four-armed creature is a girallon, a fiercely territorial creature.",
...
newEntity{ base = "BASE_NPC_MAGBEAST",
	...
	specialist_desc = [[Gorgon blood holds an unusual supernatural quality: If it is stirred into mortar, any walls built with the resulting mixture become solid barriers to ghosts and other ethereal travelers.]],
	uncommon_desc = [[Gorgons are highly aggressive, and will trample nearly any creature they see. They cannot be trained or domesticated.]],
	common_desc = [[A gorgon constantly exhales clouds of sickly green fumes. A gorgon can use these fumes as a breath weapon several times a day, instantly turning living creatures to stone.]],
	base_desc = [[This armored bull is called a gorgon.]],
...
newEntity{ base = "BASE_NPC_MAGBEAST",
	...
	uncommon_desc = [[Gray renders reproduce asexually and are never naturally encountered in groups. Despite their savage, dimly sentient nature, gray renders are sometimes known to “adopt” other creatures, seemingly at random. A gray render watches over its “ward” like a loyal pet and will even bring it fresh kills to feed upon.]],
	common_desc = [[A gray render’s flesh is exceptionally dense, rendering it incredibly strong and resilient. A gray render has a sharp sense of smell, and its six eyes grant it keen vision. When this predator attacks, it often snatches up a victim with its powerful jaws, then grabs on with its humanoid-like claws to pull the creature apart. A gray render will not hesitate to uproot trees to reach its prey.]],
	base_desc = [[This ashen behemoth is a gray render, a savage and deadly predator.]],
...
newEntity{ base = "BASE_NPC_MAGBEAST",
	...
	specialist_desc = [[A hippogriff can be trained as a mount with a degree of effort. For this reason, hippogriff eggs have been known to fetch 2,000 gp apiece on the open market, while live hatchlings can garner an additional 1,000 gp.]],
	uncommon_desc = [[Hippogriffs live as mated pairs and never stray far from their nest. They never leave their eggs or hatchlings unguarded.]],
	common_desc = [[Hippogriffs are distantly related to griffons, but are no more intelligent than common beasts. They are highly territorial and will prey on anything they can catch. When they attack, they lash out with their sharp foreclaws and beak. Hippogriffs have a keen sense of smell.]],
	base_desc = "This chimeric beast is a hippogriff, boasting the head, wings and claws of a great eagle and the body of a powerful horse.",
...
newEntity{ base = "BASE_NPC_MAGBEAST",
	...
	display = 'B', color=colors.BLACK,
	desc = [[A manticore.]],
	specialist_desc = [[Despite their predatory and malevolent nature, manticores tend to honor their word, in their own way, and as such can sometimes be recruited as allies by like-minded villains.]],
	uncommon_desc = [[A manticore’s tail spikes grow back extremely quickly, but even so the creature has only enough spikes to fling them at four or five targets a day. When a manticore closes in for the kill, it relies on its wicked talons and vicious bite.]],
	common_desc = [[A manticore is deceptively cunning and hungers for living flesh. It is capable of utilizing advanced tactics while pursuing foes. Manticores speak Common. With a flick of its tail, a manticore can whip a volley of spikes at any victim within sixty paces. When space allows, a manticore tries to remain airborne, out of the reach of its foes at it assaults them.]],
	base_desc = [[The fanged maw, spiked tail, and leathery wings of this vaguely feline horror mark it as a manticore, a cruel and deadly predator.]],
...
newEntity{ base = "BASE_NPC_MAGBEAST",
	...
	uncommon_desc = [[Owlbears are said to be the result of a mad wizards attempts to crossbreed a giant owl with a bear. They are deadly hunters and their young are incredibly valuable. When captured they are often trained as wandering guards by the wealthy.]],
	common_desc = [[The owlbear attacks its prey with its deadly claws, latching onto an opponent they then bite and claw until the victim falls dead and is devoured.
Owlbears attack any prey on sight, and consider anything larger than a mouse prey.]],
	base_desc = "This bear like creature with an owl head and feathers covering its entire body is in fact the vicious owlbear.",
...
newEntity{ base = "BASE_NPC_MAGBEAST",
	...
	specialist_desc = [[a creature not in contact with the ground say via a fly spell, and protected by a freedom of movement and a heroes’ feast spell can easily overcome a purple worm, the creature is also very susceptible to being held, slowed, and or dominated but not charmed as it has no language.
	A large amount of gems and uncut minerals can often be found in a purple worm's gullet, though cleaning it is no joy, some claim you never get rid of the smell.]],
	uncommon_desc = [[Purple worms often erupt right beneath one's feet having the ability to sense a creatures contact with the ground at close range, creatures are then snatched up as they try to flee, disappearing into their maw. Creatures they cannot grab are often stung, using it’s posion to sap it’s prey’s strength, the poison has been know to occasionally kill some in rare instances.]],
	common_desc = [[Purple worms are known to gulp creatures down in one piece, whole adventuring companies have disappeared in their bellies.]],
	base_desc = [[This magical beast is called a purple worm. Normally encountered deep underground, they are immense omnivores that devour any organic substance they come upon.]],
...
newEntity{ base = "BASE_NPC_MAGBEAST",
	...
	uncommon_desc = [[The most intelligent worgs are capable of learning languages, most often Goblin, but some have been known to speak Common.]],
	common_desc = [[Worgs trip like their wolf cousins.
	Worgs are descended from wolves that had been mutated by magic, they are far more intelligent than their wolf cousins, and can be recognized by the glint of sentience in their eyes.]],
	base_desc = "Worgs are more vicious versions of their wolf cousins recognizable by their strange eyes and slightly larger build. They hunt in packs using hit and run tactics, wearing down their prey and staying out of harm's way until they exhaust their prey whereupon they rush in from different sides flanking and pin the victim.",
...
newEntity{ base = "BASE_NPC_MAGBEAST",
	...
	specialist_desc = [[A spectral panther is also surrounded by a terrifying aura.]],
	uncommon_desc = [[A spectral panther can continue to attack material foes, even while incorporeal.]],
	common_desc = [[Several times per day, a spectral panther can shift into an insubstantial form.]],
	base_desc = [[This shadowy feline is a spectral panther.]],
