...
newEntity{ base = "BASE_NPC_UNDEAD_CORPO",
        ...
        image = "tiles/mobiles/devourer.png",
...
newEntity{
        base = "BASE_NPC_GHOUL",
        image = "tiles/mobiles/lacedon.png",
...
newEntity{ base = "BASE_NPC_UNDEAD_CORPO",
        ...
        image = "tiles/mobiles/UT/mohrg.png",
        display = 'U', color=colors.BLACK,
        desc = [[A terrible undead creature.]],
        specialist_desc = [[People killed by mohrgs rise from the grave several days later as mindless zombies under the mohrg’s control.]],
        uncommon_desc = [[These powerful undead latch onto foes with their bony hands, then continue to attack them while grappling.]],
        common_desc = [[Mohrgs are the animated corpses of unrepentant mass murderers and similar ilk. The touch of a mohrg’s long, clawed tongue paralyzes living creatures.]],
        base_desc = "The writhing intestines in this skeletal horror mark it as a mohrg. "..undead_desc.."",
...
newEntity{ base = "BASE_NPC_UNDEAD_INCORPO",
        ...
        subtype = "shadow",
        image = "tiles/mobiles/shadow.png",
        display = 'N', color=colors.WHITE,
        desc = [[An incorporeal shadow.]],
        specialist_desc = [[Although common undead shadows are dangerous enough, far more powerful varieties have also been encountered.]],
        uncommon_desc = [[A shadow’s touch carries the numbing chill of nonexistence, sapping the strength from living creatures. The souls of victims slain by a shadow’s touch rise as new shadows themselves just a few moments later, with no memory of their former existence.]],
        common_desc = [[Shadows despise light and life. They lurk in dark places, waiting for victims to wander by. A shadow is easily spotted in brightly lit areas, but effortlessly blends into the shadows in their dimly lit lairs.]],
        base_desc = "This mobile shadow is an undead spirit strongly tied to the Plane of Shadow. "..undead_desc.."",
...
newEntity{ base = "BASE_NPC_UNDEAD_CORPO",
        ...
        subtype = "nightshade",
        image = "tiles/mobiles/nightshade.png",
...
newEntity{ base = "BASE_NPC_NIGHTSHADE",
        ...
        specialist_desc = [[Creatures swallowed by a nightcrawler quickly have their life energy drained away. If pressed, a nightcrawler can summon undead spirits to its side. A nightcrawler is immune to cold. A nightcrawler has a variety of spell-like abilities, including cone of cold, confusion, contagion, deeper darkness, detect magic, finger of death, haste, hold monster, invisibility, plane shift, and unholy blight. However, the nightcrawler itself is highly resistant to magic.]],
        uncommon_desc = [[A nightcrawler can swallow smaller creatures whole with its massive maw, and its tail stinger injects a debilitating venom. A nightcrawler’s chtinous armor is incredibly resistant to damage, but magic silvered weapons can pierce its defenses.]],
        common_desc = [[Nightcrawlers are one of several kinds of undead creature called nightshades. Nightshades emit a desecrating aura, giving off unholy power like a shrine of evil. Nightshades recoil from natural sunlight; although it does not harm them, it does distract them. A nightcrawler is telepathic and can communicate with any creature with a language.]],
        base_desc = "This massive, pitch-black worm is a nightcrawler, an entity native to the Plane of Shadow. "..undead_desc.."",
