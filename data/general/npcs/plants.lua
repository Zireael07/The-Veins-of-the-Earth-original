...
newEntity{ base = "BASE_NPC_FUNGI",
	...
	image = "tiles/mobiles/shrieker.png",
	color=colors.DARK_BLUE,
	desc = [[A purple fungus.]],
	uncommon_desc = [[Other subterranean creatures often live in close proximity to shriekers, recognizing that the shrieks give warning of potential food in the vicinity. They can also regularly be found with violet fungi, the poison of which shriekers are immune to.]],
	common_desc = [[Movement or light brought within a couple of paces of a shrieker will cause the fungus to emit a piercing sound that lasts a dozen or so seconds.]],
	base_desc = "This man-sized mushroom is a shrieker, an unusual fungus that emits a loud noise when disturbed. "..plant_desc.."",
	name = "shrieker",
	rarity = 8,
	exp_worth = 400,
...
newEntity{ base = "BASE_NPC_FUNGI",
	...
	image = "tiles/mobiles/violet_fungi.png",
	display = 'F', color=colors.VIOLET,
	desc = [[A violet fungus.]],
	uncommon_desc = [[Violet fungi are often found growing among shriekers which they closely resemble.]],
	common_desc = [[As well as being paritally mobile, violet fungi also have poisonous tentacles that can incapacitate the unwary dungeoneer.]],
	base_desc = "This man sized mushroom is in fact a violet fungus, a subterranean creature that can move slowly about on a mass of small feelers. "..plant_desc.."",
...
newEntity{ base = "BASE_NPC_FUNGI",
	...
	image = "tiles/mobiles/fungi_phantom.png",
	color=colors.VIOLET,
	desc = [[A greenish silhouette of a fungus.]],
	common_desc = [[Phantom fungi are naturally invisible, allowing these shambling hunters to close in on their prey. A phantom fungus becomes visible in death, revealing its bizarre appearance and toothy maw.]],
	base_desc = "The quiet shuffling sounds in this damp cavern suggest the presence of a predatory phantom fungus. "..plant_desc.."",
