...
newEntity{ base = "BASE_LBOW",
    name = "longbow",
    image = "tiles/object/bow_long.png",
    rarity = 5,
    level_range = {1, 10},
--    cost = 75,
...
newEntity{ base = "BASE_SBOW",
    name = "shortbow",
    image = "tiles/object/bow_short.png",
    rarity = 5,
    level_range = {1, 10},
--    cost = 30,
...
newEntity{ base = "BASE_RANGED",
    ...
    image = "tiles/object/bullets.png",
    display = "*", color=colors.UMBER,
    rarity = 5,
    archery_ammo = "bullet",
